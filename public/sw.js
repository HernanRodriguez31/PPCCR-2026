...
const SHELL_CACHE = "ppccr-shell-v20260312-1";
const STATIC_CACHE = "ppccr-static-v20260312-1";
const ACTIVE_CACHES = [SHELL_CACHE, STATIC_CACHE];
const PRECACHE_URLS = [
  "/",
  "/index.html",
  "/manifest.webmanifest?v=20260312-home-shell-pwa1",
  "/styles.css?v=20260311-home-sponsors-spacing1",
  "/kpis-dashboard.css",
  "/ppccr-sankey-participantes.css",
  "/home-mobile-shell.css?v=20260312-home-shell-pwa1",
  "/host-guard.js",
  "/page-transitions.js",
  "/domain/home-algorithm-domain.js",
  "/app/home-algorithm-service.js",
  "/app.js?v=20260312-home-shell-pwa2",
  "/kpis-dashboard.js",
  "/ppccr-sankey-participantes.js",
  "/auth-gate.js?v=20260310-auth-modal-polish3",
  "/home-mobile-shell.js?v=20260312-home-shell-pwa1",
  "/pwa-register.js?v=20260312-home-shell-pwa1",
  "/assets/favicon.png",
