...
const SHELL_CACHE = "ppccr-shell-v20260323-dashboard-charts-release1";
const STATIC_CACHE = "ppccr-static-v20260323-dashboard-charts-release1";
...
const PRECACHE_URLS = [
  ...
  "/kpis-dashboard.css?v=20260323-dashboard-charts-release1",
  "/ppccr-sankey-participantes.css?v=20260323-dashboard-charts-release1",
  ...
  "/kpis-dashboard.js?v=20260323-dashboard-charts-release1",
  "/ppccr-sankey-participantes.js?v=20260323-dashboard-charts-release1",
  "/auth-gate.js?v=20260313-home-phase2-release-blockers1",
  "/home-mobile-shell.js?v=20260313-home-phase2-release-blockers1",
  "/pwa-register.js?v=20260323-dashboard-charts-release1",
  "/assets/favicon.png",
